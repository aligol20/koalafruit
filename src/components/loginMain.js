...
import {Text, AsyncStorage,Dimensions,Alert} from 'react-native';
...
export default class LoginMain extends Component {
    ...
    sendToServer() {
        if(this.state.verfiCode.length===5) {
            ...
            AsyncStorage.getItem('userPhoneNumber', (err, store) => {
                console.log(store.toString(), 'mahnazparivash2');
                let koon = JSON.parse(store);
                let yuy = [{passCode: this.state.verfiCode, phoneNumber: koon}];
     ...
     deim(){
        if(this.state.visible){
            ...
            return(
                <Text style={{color: 'white', margin: 10,fontSize:13}}>ارسال مجدد کد</Text>
    ...
    render() {
        ...
        return (
            <Root>
                <Content style={{backgroundColor: '#1bbc9b'}}>
                <ProgressDialog
                ...
                />
                    <View style={{ flex:1,flexDirection:'column',justifyContent: 'center', alignItems: 'center', margin: 20}}>
                        <View style={{width:0,height:width/2,marginBottom:30,borderWidth:0,
                ...
                <Button style={{
                        ...
                        <Text style={{color: 'white', margin: 10,fontSize:23,fontFamily:'BYekan'}}>تایید</Text>
                    </Button>
                    </View>
                        <View>
                        ...
                        <View>
                            ...
                            <Text style={{textAlign:'center',alignItems:'center',
                                justifyContent:'center',color: 'white', margin: 10,fontSize:15,fontFamily:'BYekan'}} onPress={() => Actions.account()}>شماره  را اشتباه نوشته اید؟</Text>
                    </View>
                        <View>
                            <Text style={{textAlign:'center',color:'white',marginTop:20,fontFamily:'BYekan'}}>پیامکی حاوی کد پنج رقمی برای شما ارسال شد،آن را در کادر بالا وارد نمایید</Text>
