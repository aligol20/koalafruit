                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Image
                            ...
                            source={require('../imageSource/icon-new.png')}
                        />
                    </View>
                    <View style={{width: width / 2}}>
                        ...
                        <Input placeholder='09xxxxxxxxx'
                               maxLength={11}
                               style={{
                                   backgroundColor: '#1bbc9b', borderWidth: 2,
                    ...
                    <View>
                        <Button
                            ...
                            <Text style={{color: 'white', textAlign: 'center',fontFamily:'BYekan'}}>دریافت کد تایید</Text>
                        </Button>
                    </View>
                    <View>
                        ...
                        <Text style={{fontFamily:'BYekan',
                            backgroundColor: '#1bbc9b',
                            justifyContent: 'center',
                            alignItems: 'center', width: width / 3, color: 'white', textAlign: 'center', margin: 10
                        }} onPress={ Actions.register}>ثبت نام نکرده اید؟</Text>
                    </View>
                    <View>
                        <Text style={{textAlign:'center',color:'white',marginTop:20,fontFamily:'BYekan'}}>شماره همراه خود را وارد کنید و تایید کنید،کد فعال سازی برای شما ارسال خواهد شد</Text>
